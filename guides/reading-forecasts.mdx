...
description: "How to interpret CCU forecasts and confidence intervals"
icon: "chart-line"
---

Forecasts predict future CCU for your tracked games using Meta's Prophet time-series model.
...
<AccordionGroup>
  ...
  <Accordion title="Seasonal patterns matter">
    Prophet automatically detects weekly patterns (weekday vs. weekend) and seasonal trends (holiday spikes).
  </Accordion>
...
- **Use with benchmarking**: Combine forecasts with genre benchmarks to understand if growth is above or below genre norms
